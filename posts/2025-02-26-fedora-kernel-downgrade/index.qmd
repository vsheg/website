---
date: 2025-02-26
image: posts/2025-02-26-fedora-kernel-downgrade/cover.png
title: "Fedora: Downgrade kernel"
categories:
  - admin
---

Fedora's approach to kernel updates is like a 'rolling release'. Kernels are updated frequently, and this may break your system. After I applied Fedora updates, it installed the new kernel version `6.13.4`, causing the NVIDIA driver and CUDA drivers to break.
